...
class ProfileController(
    ...
    fun risks(@PathVariable("targetId") targetId: IRI): TargetRisksResponse {
        val target = entityResolver.resolveEntities(targetId)!!
    ...
    @Get("/profile/{targetId}/ultimate-parents")
    @View("profile/ultimate-parents")
    ...
    private fun TreeResponse.profileTreeResponse(target: IRI): ProfileResponse<String> {
        return ProfileResponse(
            target = entityResolver.resolveEntities(target)!!,
